		...
		<section className={'bg-section-0 pt-[110px] pb-[160px]'}>
			<div className="container">
				<div className={'w-1/2 mb-12'}>
					...
					<h1 className={'font-bold text-[44px] leading-normal text-white pb-2.5'}>Find the Doctor Recommended Medicines You Need at Affordable Prices.</h1>
					<p className={'text-[rgba(255,255,255,0.7)] leading-9 text-xl font-medium pb-7'}>Lorem ipsum dolor sit amet, consectetur adipiscing elit,</p>
					<a href="#" className={'text-sm font-bold bg-[#ff5473] inline-block py-5 px-4 text-white leading-6 rounded-full capitalize'}>shop medicines</a>
				</div>
				<div className={'flex gap-5'}>
					<div className={'inline-flex text-white gap-5'}>
						...
						<div>
							...
							<p className={'leading-6 text-sm font-medium pb-4 w-1/2'}>Donec rutrum congue leo eget malesuada. Donec sollicitudin. Lorem ipsum dolor sit amet</p>
